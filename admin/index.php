          ...
          <div class="col-md-12">
           ...
           $stmt=$pdo->prepare("SELECT * FROM posts WHERE title LIKE '%$searchkey%' ");
             ...
             ?>
              <!-- /.card-header -->
              <div class="card-body">
                <a href="add.php" class="btn btn-success">Create New block post</a>
                <div><br></div>
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <td><?php echo substr($u['content'],0,50) ?></td>
                      ...
                      <a href="edit.php?id=<?php echo$u['id']; ?>" class="btn btn-warning">edit</a>
                  
                    
                      <a href="delete.php?id=<?php echo $u['id']; ?>"  onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-warning">delete</a>
